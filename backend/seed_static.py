...
"python-zero": [
  ...
  },
  {
    ...
    "theory": "## Como ler dados do usuário?\n\nA função `input()` **pausa o programa e espera o usuário digitar algo**. O que for digitado fica guardado em uma variável:\n\n```python\nnome = input()\n```\nSe o usuário digitar `Carlos`, a variável `nome` passa a valer `\"Carlos\"`.\n\n---\n\n## Exibindo o resultado com f-string\n\nUse uma **f-string** para montar a mensagem com a variável:\n\n```python\nnome = input()\nprint(f\"Bem-vindo, {nome}!\")\n```\n\n| Entrada do usuário | Saída na tela |\n|---|---|\n| `Carlos` | `Bem-vindo, Carlos!` |\n| `Ana` | `Bem-vindo, Ana!` |\n\n---\n\n## ⚠️ Regra importante\n\nDeixe o `input()` **sem texto dentro dos parênteses**:\n\n```python\nnome = input()        # ✅ correto\nnome = input(\"Nome:\") # ❌ não use — o texto aparece na saída e quebra o teste\n```\n\n---\n\n## O que você vai programar\n\nNo exercício, o código inicial já tem `nome = input()`. Você só precisa **completar a linha do `print`**:\n\n```python\n# Código inicial (já está no editor):\nnome = input()\nprint( ... )  # ← substitua ... por f\"Bem-vindo, {nome}!\"\n\n# Código completo correto:\nnome = input()\nprint(f\"Bem-vindo, {nome}!\")\n```\n\n**Entrada fornecida pelo teste:** `Carlos`  \n**Saída esperada:**\n```\nBem-vindo, Carlos!\n```",
    "starter_code": '# Leia o nome do usuário\nnome = input()\n\n# Complete o print para exibir: Bem-vindo, <nome>!\nprint( ... )\n',
    "hint": "Use uma f-string dentro do print: f\"Bem-vindo, {nome}!\"",
    "hints": [
      "`input()` guarda o que o usuário digitou — o teste passa `Carlos` automaticamente.",
      "Use f-string: coloque `f` antes das aspas e `{nome}` onde a variável deve aparecer.",
      "A linha completa é: `print(f\"Bem-vindo, {nome}!\")`",
    ],
    "tests": [{"stdin": "Carlos", "expected_stdout": "Bem-vindo, Carlos!"}],
    "quiz": [
  ...
  },
  {
    ...
    "hints": [
      'Preencha os valores do dicionário: `"Carlos"` para nome, `15` para idade, `8.5` para nota.',
...
"javascript-zero": [
  ...
  },
  {
    ...
    "title": "Listas (Arrays)",
    "chapter": "Capítulo 2: Controle de Fluxo",
    "instruction_pt": "Arrays guardam vários valores em uma variável só!\n\n```js\nconst cidades = [\"São Paulo\", \"Rio de Janeiro\", \"Fortaleza\"]\nconsole.log(cidades[0])     // São Paulo\nconsole.log(cidades.length) // 3\n```\n\nSua tarefa: crie um array com 3 times brasileiros, percorra com `for` e imprima cada nome, depois o total:\n```\nFlamengo\nCorinthians\nPalmeiras\nTotal de times: 3\n```",
