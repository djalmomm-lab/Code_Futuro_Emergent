...
"python-zero": [
  ...
  },
  {
    ...
    "chapter": "Capítulo 2: Controle de Fluxo",
    "theory": "## Repetindo com for\n\nO loop `for` com `range()` repete um bloco de codigo um numero especifico de vezes.\n\nExemplo basico — contar de 1 a 5:\n\n```python\nfor i in range(1, 6):\n    print(i)\n```\n\nSaida:\n```\n1\n2\n3\n4\n5\n```\n\n## Entendendo o range()\n\n- `range(5)` gera: 0, 1, 2, 3, 4 — **comeca em 0**\n- `range(1, 6)` gera: 1, 2, 3, 4, 5 — **de 1 ate 5**\n- `range(1, 6)` termina ANTES do 6 — o ultimo numero nao e incluido!\n\n## Usando for com calculos\n\nPodemos fazer contas dentro da f-string:\n\n```python\nfor i in range(1, 4):\n    print(f\"2 x {i} = {2 * i}\")\n```\n\nSaida:\n```\n2 x 1 = 2\n2 x 2 = 4\n2 x 3 = 6\n```\n\n## No exercicio voce vai fazer a tabuada do 5\n\nO resultado esperado e:\n```\n5 x 1 = 5\n5 x 2 = 10\n5 x 3 = 15\n5 x 4 = 20\n5 x 5 = 25\n```",
