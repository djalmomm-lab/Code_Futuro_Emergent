...
"sql": [
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT * FROM usuarios;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT * FROM usuarios WHERE idade > 18;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': "INSERT INTO usuarios (nome, email) VALUES ('Maria', 'maria@email.com');",
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': "UPDATE usuarios SET email = 'novo@email.com' WHERE id = 1;",
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'Nada',
          'Atualiza apenas a primeira linha',
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'DELETE FROM usuarios WHERE id = 5;',
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'Por convenção',
          'Para evitar remover todos os registros',
          'Por performance',
          'É obrigatório',
        ],
        'correct': 1,
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT * FROM usuarios ORDER BY nome ASC;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT * FROM produtos LIMIT 3;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT COUNT(*) FROM usuarios;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'title': 'GROUP BY',
    'chapter': 'Capítulo 3: Consultando com Estilo',
    'theory': '`GROUP BY` agrupa linhas com o mesmo valor — sempre usado com funções de agregação.\n\n## Como funciona\n\n```sql\nSELECT cidade, COUNT(*) FROM clientes GROUP BY cidade;\n```\n\n## No exercício\n\nEscreva a query que mostra quantos usuários existem por cidade.',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT cidade, COUNT(*) FROM usuarios GROUP BY cidade;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'instruction_pt': '`JOIN` combina linhas de duas tabelas com base em uma coluna relacionada. `INNER JOIN` retorna apenas as linhas com correspondência em ambas. Una as tabelas `usuarios` e `pedidos` pelo id do usuário, selecionando `u.nome` e `p.produto`.\n\nVeja um exemplo:\n\n```sql\nSELECT p.nome, c.cidade\nFROM pessoas p\nINNER JOIN cidades c ON p.cidade_id = c.id;\n```',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'SELECT u.nome, p.produto FROM usuarios u INNER JOIN pedidos p ON u.id = p.usuario_id;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'CREATE TABLE produtos (id INT, nome VARCHAR(100), preco DECIMAL(10,2));',
      },
    ],
    'quiz': [
      {
      ...
      {
        'question': 'O que é PRIMARY KEY em SQL?',
        'options': [
          'A primeira coluna da tabela',
          'Um índice único que identifica cada registro',
          'Uma senha da tabela',
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'ALTER TABLE usuarios ADD COLUMN telefone VARCHAR(15);',
      },
    ],
    'quiz': [
      {
        'question': 'Qual comando SQL modifica a estrutura de uma tabela?',
        'options': [
          'MODIFY TABLE',
          'CHANGE TABLE',
          'ALTER TABLE',
      ...
      {
        'question': 'Como adicionar uma coluna com ALTER TABLE?',
        'options': [
          'ADD COLUMN',
          'INSERT COLUMN',
          'APPEND COLUMN',
