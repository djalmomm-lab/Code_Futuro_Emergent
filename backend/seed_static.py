...
"python-zero": [
  {
    ...
    "instruction_pt": '`print()` exibe qualquer texto na tela. Basta passar o texto entre aspas nos parênteses:\n\n  print("Olá, Mundo!")\n\nAspas duplas " e simples \' são equivalentes em Python. O código ao lado já está correto — clique em **Executar** para ver o resultado!',
    "instruction_en": '`print()` displays any text on screen. Just pass the text in quotes inside the parentheses:\n\n  print("Olá, Mundo!")\n\nDouble " and single \' quotes are equivalent in Python. The code is already correct — click **Run** to see the result!',
    "instruction_es": '`print()` muestra cualquier texto en pantalla. Solo pasa el texto entre comillas en los paréntesis:\n\n  print("Olá, Mundo!")\n\nLas comillas dobles " y simples \' son equivalentes en Python. ¡El código ya está correcto — haz clic en **Ejecutar** para ver el resultado!',
    "starter_code": '# print() exibe texto na tela\n# O texto fica entre aspas nos parênteses\nprint("Olá, Mundo!")\n',
    "hint": 'Use print("Olá, Mundo!") — aspas simples \' ou duplas " funcionam igualmente.',
  ...
  },
  {
    ...
    "title": "Variáveis",
    "chapter": "Capítulo 1: Primeiros Passos",
    "instruction_pt": "Variáveis guardam dados. Use `nome = valor` para criá-las. F-strings inserem variáveis em texto com `{variavel}` — basta colocar `f` antes das aspas:\n\n  f\"Olá, {nome}!\"\n\nAs variáveis já estão declaradas. O `print` ao lado usa f-string — execute e veja o resultado!",
