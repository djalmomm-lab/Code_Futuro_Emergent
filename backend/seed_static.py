...
"python-zero": [
  ...
  },
  {
    ...
    "instruction_pt": "Complete os dois `___` no código ao lado.\n\n**Como o return funciona:**\n```python\ndef dobrar(n):\n    return n * 2      # devolve o resultado\n\nprint(dobrar(5))      # imprime: 10\nprint(dobrar(3))      # imprime: 6\n```\nO `return` **devolve** um valor — quem chamou a função recebe esse valor.\n\n**O que preencher:**\n- **1º `___`** — o parâmetro: o nome que chega na função (use `nome`)\n- **2º `___`** — o que retornar: uma f-string como `f\"Olá, {nome}!\"`\n\n**Resultado esperado:**\n```\nOlá, Ana!\n```",
