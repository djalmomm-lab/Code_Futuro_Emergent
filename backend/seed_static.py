...
"python-zero": [
  ...
  },
  {
    ...
    "instruction_pt": "Crie uma variável chamada `nome` com o valor `\"Ana\"` e outra chamada `idade` com o valor `12`. Depois imprima na tela a frase exata: `Ana tem 12 anos`.\n\nExemplo de saída esperada:\n```\nAna tem 12 anos\n```",
    "instruction_en": "Create `nome = \"Ana\"` and `idade = 12` then print `Ana tem 12 anos`.",
    "instruction_es": "Crea `nome = \"Ana\"` y `idade = 12` y muestra `Ana tem 12 anos`.",
