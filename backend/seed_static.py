...
"java": [
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'System.out.println("Olá, Java!");',
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'Imprime em vermelho',
          'Não adiciona quebra de linha no final',
  ...
  },
  {
    ...
    'chapter': 'Capítulo 1: Fundamentos Java',
    'theory': 'Java é fortemente tipado — toda variável precisa de um tipo declarado.\n\n## Como funciona\n\n```java\nint pontos = 100;\n```\n\n## No exercício\n\nEscreva a declaração de um inteiro `idade` com valor 25.',
    ...
    'quiz': [
      ...
      },
      {
        ...
        'options': [
          ...
          'Fortemente tipada (requer declaração de tipo)',
          'Sem tipos',
          'Tipada opcionalmente',
        ],
        'correct': 1,
      },
    ],
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'public static int dobrar(int n) {',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'O método não muda',
          'O método pertence à classe, não a uma instância',
          'O método é privado',
          'O método é final',
        ],
        'correct': 1,
  ...
  },
  {
    ...
    'theory': "Java usa `if (condição) { ... } else { ... }` para tomar decisões.\n\n## Como funciona\n\n```java\nif (idade >= 18) {\n```\n\n## No exercício\n\nEscreva a estrutura `if` que verifica se a variável `x` é maior que zero e imprime `'positivo'`.",
  ...
  },
  {
    ...
    'title': 'Loop For',
    'chapter': 'Capítulo 3: Controle de Fluxo',
    'theory': 'O `for` em Java tem três partes: inicialização, condição e incremento.\n\n## Como funciona\n\n```java\nfor (int i = 10; i > 0; i--) {\n```\n\n## No exercício\n\nEscreva o cabeçalho do `for` que conta de 0 até 4 (i < 5).',
    ...
    'quiz': [
      {
        ...
        'options': [
          'condição; incremento; init',
          'init; condição; incremento',
          'incremento; init; condição',
          'init; incremento; condição',
        ],
        'correct': 1,
      },
      {
  ...
  },
  {
    ...
    'chapter': 'Capítulo 3: Controle de Fluxo',
    'theory': '`String` em Java é uma classe — use `.length()` para obter o número de caracteres.\n\n## Como funciona\n\n```java\nString saudacao = "Bem-vindo";\n```\n\n## No exercício\n\nEscreva a linha que declara a `String` chamada `msg` com o valor `\'Olá\'` e em seguida chama `msg.length()`.',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'String msg = "Olá";',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'Um tipo primitivo como int',
          'Uma classe (objeto)',
          'Um array de char básico',
          'Um tipo numérico',
        ],
        'correct': 1,
      },
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'ArrayList<String> nomes = new ArrayList<>();',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'Array é mais lento',
          'ArrayList tem tamanho dinâmico, Array tem tamanho fixo',
          'ArrayList não aceita objetos',
          'São idênticos',
        ],
        'correct': 1,
      },
  ...
  },
  {
    ...
    'chapter': 'Capítulo 4: Coleções',
    'theory': 'Uma classe em Java agrupa dados e comportamentos; o construtor inicializa o objeto.\n\n## Como funciona\n\n```java\nProduto(String nome) {\n```\n\n## No exercício\n\nEscreva a assinatura do construtor da classe `Pessoa` que recebe o parâmetro `String nome` e atribui `this.nome = nome`.',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'Pessoa(String nome) {',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          ...
          'Sempre retorna void',
          "É chamado com 'create'",
          'É opcional em toda classe',
        ],
        'correct': 0,
      },
      {
  ...
  },
  {
    ...
    'theory': 'Herança em Java usa `extends` — a subclasse herda atributos e métodos da superclasse.\n\n## Como funciona\n\n```java\npublic class Gerente extends Funcionario {\n```\n\n## No exercício\n\nEscreva a declaração da classe `Aluno` que herda de `Pessoa`.',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'public class Aluno extends Pessoa {',
      },
    ],
    'quiz': [
      {
