...
"python-zero": [
  ...
  },
  {
    ...
    "chapter": "Capítulo 2: Controle de Fluxo",
    "theory": "O loop `for` repete um bloco de codigo um numero fixo de vezes. Neste exercicio voce vai usar o `for` para imprimir a tabuada do 5.\n\n## O que voce vai construir\n\n```\n5 x 1 = 5\n5 x 2 = 10\n5 x 3 = 15\n5 x 4 = 20\n5 x 5 = 25\n```\n\n## Como o for funciona\n\nO `for` usa `range()` para saber quantas vezes repetir:\n\n```python\nfor i in range(1, 6):\n    print(i)\n```\n\nIsso imprime os numeros de 1 a 5. O `i` assume cada valor do range a cada repeticao.\n\n## range(inicio, fim)\n\n- O primeiro numero e de onde comecar\n- O segundo numero e ate onde ir — **mas nao inclui o ultimo!**\n- `range(1, 6)` gera: 1, 2, 3, 4, 5\n\n## Fazendo contas dentro do for\n\nPodemos usar `i` em calculos dentro da f-string:\n\n```python\nfor i in range(1, 4):\n    print(f\"3 x {i} = {3 * i}\")\n```\n\nSaida:\n```\n3 x 1 = 3\n3 x 2 = 6\n3 x 3 = 9\n```\n\nNo exercicio o raciocinio e o mesmo — mas com o numero 5 e indo de 1 a 5.",
