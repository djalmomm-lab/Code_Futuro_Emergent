...
"python-zero": [
  ...
  },
  {
    ...
    "chapter": "Capítulo 1: Primeiros Passos",
    "instruction_pt": "`input()` lê o que o usuário digita e retorna uma string. Use-o junto com `print()` para criar programas interativos:\n\n  nome = input()\n  print(f\"Olá, {nome}!\")\n\nComplete o código para ler um nome e exibir: `Bem-vindo, <nome>!`",
    ...
    "hints": [
      "`input()` retorna o que o usuário digitou — o teste passa 'Carlos' como entrada.",
      "Adicione: `print(f\"Bem-vindo, {nome}!\")` após a linha `nome = input()`.",
    ],
