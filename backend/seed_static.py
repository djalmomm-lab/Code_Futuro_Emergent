...
"typescript": [
  {
    ...
    'theory': 'TypeScript adiciona tipos ao JavaScript — declarar o tipo de uma variável ajuda a evitar erros.\n\n## Como funciona\n\n```typescript\nlet idade: number;\n```\n\n## No exercício\n\nEscreva a declaração de uma variável `nome` do tipo `string` sem valor inicial.',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'let nome: string;',
      },
    ],
    'quiz': [
      {
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'function somar(a: number, b: number): number {',
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'Código mais lento',
          'Evitar erros de tipo em tempo de compilação',
  ...
  },
  {
    ...
    'theory': 'Interfaces definem a forma de objetos.\n\n## Como funciona\n\n```typescript\ninterface Produto { nome: string; preco: number; }\n```\n\n## No exercício\n\nEscreva a interface `Aluno` com os campos `nome` (string) e `idade` (number) em uma linha, sem quebras de linha.',
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'interface Aluno { nome: string; idade: number; }',
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'Executar funções',
          'Definir a forma esperada de objetos',
          'Criar loops',
      ...
      },
      {
        ...
        'options': [
          'Não',
          'Sim, cada propriedade tem seu próprio tipo',
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': "type Cor = 'vermelho' | 'azul' | 'verde';",
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'Renomeia variáveis',
          'Cria um apelido reutilizável para um tipo',
      ...
      {
        'question': 'Qual símbolo separa valores em union types?',
        'options': [
          '&',
          '|',
          '+',
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'let id: number | string;',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'id pode ser number e string ao mesmo tempo',
          'id pode ser number ou string',
          'id é do tipo number_string',
          'Erro de sintaxe',
        ],
        'correct': 1,
      },
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'let numeros: number[] = [1, 2, 3];',
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'Um número com índice',
          'Um array de números',
          'Uma matriz 2D',
          'Um tipo numérico especial',
        ],
        'correct': 1,
      },
    ],
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'interface Config { debug?: boolean; }',
      },
    ],
    'quiz': [
      {
      ...
      },
      {
        ...
        'options': [
          'debug é obrigatório boolean',
          'debug pode estar ausente ou ser boolean',
          'debug é sempre true',
          'debug aceita qualquer tipo',
        ],
        'correct': 1,
      },
    ],
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'enum Direcao { Norte, Sul, Leste, Oeste }',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'Criar loops',
          'Definir um conjunto de constantes nomeadas',
          'Fazer herança',
          'Importar módulos',
        ],
        'correct': 1,
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'function identidade<T>(valor: T): T {',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'O nome da função',
          'Um tipo que será definido na chamada',
          'TypeScript interno',
          'Um template HTML',
        ],
        'correct': 1,
      },
      {
        ...
        'options': [
          'Código mais rápido',
          'Reutilização tipada para qualquer tipo',
          'Menos memória',
  ...
  },
  {
    ...
    'tests': [
      {
        'stdin': '',
        'expected_stdout': 'constructor(public nome: string) {}',
      },
    ],
    'quiz': [
      {
        ...
        'options': [
          'Deixa a classe pública',
          'Cria e atribui automaticamente a propriedade',
          'Permite herança',
